...
# MAGIC
# MAGIC For the second section, you will deploy a model with with an **online feature table usig the API**. 
# MAGIC
...
fs_endpoint_name = "lab4_ml_online_features_endpoint"
try:
   w.<FILL_IN>(
     name=<FILL_IN>,
     config=<FILL_IN>,
...
# MAGIC ### Task 5: Query the Endpoint
# MAGIC
# MAGIC After the endpoint is created, it is time to test it. Use the followin hard-coded test-sample to query the endpoint using the API.
